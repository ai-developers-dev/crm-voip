...
/** Filter nav items by role. Only shows items where the tenant route
 *  exists — items without routes (SMS, Tasks, Pipelines, AI Agents)
 *  show only in the admin tenant view to avoid 404s. */
